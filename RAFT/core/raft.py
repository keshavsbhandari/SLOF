...
class RAFT(nn.Module):
    ...
    def transform(self):
        ...
        setattr(self, 'fnet',Wrapper360(nnlayer=getattr(self, 'fnet')))
        setattr(self, 'cnet',Wrapper360(nnlayer=getattr(self, 'cnet')))
        setattr(self, 'update_block',Wrapper360(nnlayer=getattr(self, 'update_block')))
